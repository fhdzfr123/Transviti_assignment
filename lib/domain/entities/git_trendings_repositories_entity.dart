class GitTrendingRepositoriesEntity {
  int? totalCount;
  bool? incompleteResults;
  List<Repository>? repositories;

  GitTrendingRepositoriesEntity(
      {this.totalCount, this.incompleteResults, this.repositories});

  GitTrendingRepositoriesEntity.fromJson(Map<String, dynamic> json) {
    totalCount = json['total_count'];
    incompleteResults = json['incomplete_results'];
    if (json['items'] != null) {
      repositories = <Repository>[];
      json['items'].forEach((v) {
        repositories!.add(new Repository.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.repositories != null) {
      data['items'] = this.repositories!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
